    ...
    <div class="row">
      <div class="col-md-8 d-flex flex-column">
        ...
        <client-only>
          <p
            class="text-justify"
            v-html="$options.filters.truncate(job.description, 150)"
          ></p>
        </client-only>
        <div class="mt-auto">
          <span
      ...
      <div
        class="col-md-4 d-flex flex-column align-items-start align-items-md-end mt-3 mt-md-0"
      >
        <div class="mb-2">
