...
export default {
  ...
  data() {
    return {
      ...
      address: {
        street: this.$auth.user.address ? this.$auth.user.address.street : null,
        city: this.$auth.user.address ? this.$auth.user.address.city : null,
        state: this.$auth.user.address ? this.$auth.user.address.state : null,
  ...
  methods: {
    ...
    async save() {
      try {
        const response = await this.$axios.post("/sellers/overview", {perHour: this.perHour, address: this.address});
