    ...
    <div v-if="job">
      ...
      <PageHeader>
        ...
        >
          ...
          <button
            v-if="$auth.loggedIn && $auth.user.type === 'seller'"
              ...
              <div class="card border-0 rounded-0">
                <div class="card-body p-4">
                  ...
                  <div class="mt-3">
                    ...
                    <span
                      class="mt-2 text-primary border border-primary px-5 py-2 rounded-pill d-inline-block"
                    >
                      {{ job.category.name }}
                    </span>
                  </div>
                  ...
                  <div class="mt-3">
                    ...
                    <span
                      href="#"
                      class="badge border border-primary text-primary rounded-pill px-3 me-2 mt-2"
