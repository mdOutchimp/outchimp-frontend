    ...
    <div class="row pt-5 pb-5 justify-content-center">
      ...
      <div class="col-lg-8">
        <div class="card border-0 rounded-0 mb-3">
          <div class="card-body">
            <nuxt-link to="/buyers/dashboard" class="text-decoration-none"
              >Dashboard</nuxt-link
            >
            <span class="px-4">|</span>
            <nuxt-link to="/buyers/dashboard/jobs" class="text-decoration-none"
              >Jobs</nuxt-link
            >
            <span class="px-4">|</span>
            <nuxt-link
              to="/buyers/dashboard/orders"
              class="text-decoration-none"
              >Orders</nuxt-link
            >
            <span class="px-4">|</span>
            <nuxt-link to="/buyers/dashboard/bids" class="text-decoration-none"
              >Bids</nuxt-link
            >
          </div>
        </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="card border-0 rounded-0 shadow-sm mt-3 mt-lg-0 mb-3">
          <div
            class="p-2 px-3 d-flex flex-column align-items-center border-bottom"
          >
          ...
          <div class="card-body">
            <div class="row justify-content-center">
              <div class="col-6">
                <nuxt-link
                  to="/buyers/dashboard/jobs"
                  class="btn btn-grey-light form-control border-0 rounded-0 fw-bold fs-7 text-decoration-none"
                >
                  ALL JOBS
                </nuxt-link>
              </div>
              <div class="col-6">
                <button
                  class="btn btn-primary form-control border-0 rounded-0 fw-bold fs-7"
                  @click.prevent="$router.push({ path: '/jobs/create' })"
                >
                  POST A JOB
                </button>
              </div>
