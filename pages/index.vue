								...
								<div class="card-body d-flex align-items-center">
									...
									<div class="testimonial-card__content">
										...
										<div class="mt-2">
											...
											<span class="fs-6">Member Since {{review.author.memberSince}}</span>
										</div>
									</div>
								</div>
							</div>
...
export default {
	...
	computed: {
		...mapGetters({
			...
			totalBuyers: "global/getTotalBuyers",
			totalSellers: "global/getTotalSellers",
			totalTransaction: "global/getTotalTransaction",
			reviews: "global/getReviews",
		}),
	},
	data() {
		return {
