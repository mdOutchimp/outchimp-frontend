            ...
            <div class="card-body">
              ...
              <form class="mt-3">
                ...
                <div class="mb-3">
                  ...
                  <Error
                    v-if="validationErrors.subCategory"
                    :messages="validationErrors.subCategory"
                  ></Error>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <Error
                    ...
                    :messages="validationErrors.image"
                  ></Error>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <Error
                    ...
                    :messages="validationErrors.tags"
                  ></Error>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <Error
                    ...
                    :messages="validationErrors.price"
                  ></Error>
                </div>

                <!-- Delivery Within -->
                <div class="mb-3">
                  <label for="delivery_within" class="form-label fw-bold"
                    >Delivery Within</label
                  >
                  <input
                    type="number"
                    v-model="pkg.deliveryWithin"
                    class="form-control"
                    id="delivery_within"
                    min="0"
                  />
                  ...
                  <Error
                    v-if="validationErrors.deliveryWithin"
                    :messages="validationErrors.deliveryWithin"
                  ></Error>
                </div>

                <!-- Revision -->
                <div class="mb-3">
                  <label for="revision" class="form-label fw-bold"
                    >Revision</label
                  >
                  <input
                    type="number"
                    ...
                    id="revision"
                    min="0"
                    v-model="pkg.revision"
                  />
                  <div class="fs-7 fst-italic text-grey">
                    Leave blank for unlimited revisions
                  </div>
                  <Error
                    v-if="validationErrors.revision"
                    :messages="validationErrors.revision"
                  ></Error>
                </div>
                ...
                <div>
                  ...
                  <div class="d-flex">
                    ...
                    <button
                      class="btn btn-primary rounded-pill px-5 ms-3"
                      @click.prevent="
                  ...
                  <ul class="mt-3 px-3" v-if="pkg.highlights">
                    <li
                      class="text-primary"
                      v-for="(hlight, index) in pkg.highlights"
                      :key="index"
                      @click="
                    ...
                    >
                      ...
                      <span
                        class="mx-1"
                        @click.stop="deleteHighlight(deleteIndex)"
                ...
                <div>
                  ...
                  <div class="d-flex">
                    ...
                    <button
                      class="btn btn-primary rounded-pill px-5 ms-3"
                      @click.prevent="addReq(reqText, reqIndex)"
                    >
                      Add
                    </button>
                  </div>
                  <ul class="mt-3 px-3" v-if="pkg.requirements">
                    <li
                      class="text-primary"
                      v-for="req in pkg.requirements"
                      :key="req"
                      @click="reqText = req"
                    >
                      {{ req }}

                      <span class="mx-1" @click.stop="deleteReq(deleteIndex)"
                        ><i class="fas fa-times"></i
                      ></span>
                    </li>
                  </ul>
...
export default {
  ...
  methods: {
    async updatePackage() {
      try {
        ...
        await this.$axios.$put(`/packages/${this.$route.params.id}`, this.pkg);
  ...
  async fetch() {
    ...
    try {
      // package Response
      const res = await this.$axios.get(`/packages/${this.$route.params.id}`);
