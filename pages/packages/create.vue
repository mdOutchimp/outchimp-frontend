            ...
            <form @submit.prevent="createPackage()" ref="packageForm">
              ...
              <div>
                ...
                <ul class="mt-3 px-3">
                  <li
                    class="text-primary"
                    v-for="(highlight, index) in pkg.highlights"
                    :key="index"
                  >
                    {{ highlight }}
                  </li>
              ...
              <div>
                ...
                <ul class="mt-3 px-3">
                  <li
                    class="text-primary"
                    v-for="(requirement, index) in pkg.requirements"
                    :key="index"
                  >
                    {{ requirement }}
                  </li>
  ...
  methods: {
    async createPackage() {
      ...
      try {
        ...
        const responsePkg = await this.$axios.$post("/packages", this.pkg);
