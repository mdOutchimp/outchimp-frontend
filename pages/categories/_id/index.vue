    ...
    <section class="section-padding container">
      ...
      <div class="row mb-4" v-if="allSubCategories.length">
        <splide :options="subCategoryOptions">
          ...
          >
            <div class="py-2">
              <nuxt-link
                :to="`/packages?subCategory=${subCategory.value}`"
                class="subCategoryButton shadow-sm fs-7 text-grey"
              >
                {{ subCategory.display }}
              </nuxt-link>
            </div>
      ...
      <client-only v-for="subCategory in subCategories" :key="subCategory.id">
        <div class="row" v-if="subCategory.packages.length">
          <div
            class="d-flex mb-3 align-items-center justify-content-between border-bottom pb-2"
          >
            ...
            <nuxt-link
              :to="`/packages?subCategory=${subCategory.id}`"
              class="mt-2 fw-bold text-primary text-decoration-none"
            >
