					...
					<div class="row">
								...
								<div class="card-body p-0">
									...
									<div class="mt-3 px-3">
										...
										<div v-if="order.attachments && order.attachments.length">
											...
											<button class="btn btn-warning btn-sm text-white py-0 ms-4 d-none" @click="onRemoveAttachment(index)">
									...
									<div class="mt-4 px-3">
										...
										<form ref="attachments" class="file-upload-wrapper mt-3 border rounded border-primary d-flex justify-content-center align-items-center w-100" style="height: 150px">
											<input type="file" id="input-file-now" class="file-upload" multiple @change="onFileChanged" />
										</form>
									</div>
						...
						<div class="col-lg-4 mt-3 mt-lg-0">
                          ...
                          " class="rounded-circle d-block" style="max-width: 100px" />
									...
									<button class="d-block btn btn-outline-primary text-decoration-none rounded-pill mt-3 px-4 w-100">
										Contact
									</button>
								</div>
							</div>
