	...
	<div class="sign-up">
		<div class="card border-0 rounded-0 py-3">
			<div class="card-body p-4">
				...
				<div class="mb-3">
					<input id="email" type="email" class="form-control py-2 mb-0" placeholder="Email" v-model="formData.email" />
				...
				<div class="mb-3 fs-7 d-flex align-items-center">
					...
					<NuxtLink to="/sellers/forgot-password" class="text-primary ms-auto">Forgot password?</NuxtLink>
				</div>

				<button class="btn btn-primary rounded-0 mb-3 w-100 py-2" @click="login()">
				...
				<p class="text-center">
					Not a member yet?
					<span>
						<NuxtLink class="text-primary text-decoration-none" to="/signup">Join Now</NuxtLink>
					</span>
				</p>
			</div>
		</div>
