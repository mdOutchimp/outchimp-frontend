			...
			<div class="row pt-5 pb-5 justify-content-center">
				...
				<div class="col-lg-8">
					<div class="card border-0 rounded-0 shadow-sm">
						<div class="card-body">
							<!-- tab items -->
							<div>
								<NuxtLink to="/sellers/dashboard" class="text-decoration-none">Dashboard</NuxtLink>
								<span class="px-4">|</span>
								<NuxtLink to="/sellers/dashboard/orders" class="text-decoration-none">Orders</NuxtLink>
								<span class="px-4">|</span>
								<NuxtLink to="/sellers/dashboard/packages" class="text-decoration-none">Packages</NuxtLink>
								<span class="px-4">|</span>
								<NuxtLink to="/sellers/dashboard/bids" class="text-decoration-none">Bids</NuxtLink>
							</div>
							<!-- tab items end -->
						</div>
					</div>
				...
				<div class="col-lg-4">
					<div class="card border-0 rounded-0 shadow-sm mt-3 mt-lg-0 mb-3">
						<div class="p-2 px-3 d-flex align-items-center justify-content-between border-bottom">
							<div class="d-flex align-items-center">
								<img :src="
                    $auth.user.profilePicture.length
                      ? $auth.user.profilePicture
                      : require('@/assets/images/profile.png')
                  " class="rounded-circle py-1" style="width: 40px" alt="" />
								<h6 class="mt-2 ms-3 fw-bold">{{ $auth.user.name }}</h6>
							</div>
							<NuxtLink to="/sellers/profile">
								<button class="btn btn-outline-primary rounded-pill px-4 btn-sm fs-8 ms-3">
									Edit
								</button>
							</NuxtLink>
						</div>
