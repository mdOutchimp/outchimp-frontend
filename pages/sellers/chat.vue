          ...
          <div class="card border-0 rounded-0">
            <div class="card-body p-0">
              <div class="chat-box d-flex flex-column" v-if="activeUser">
                <div
                  class="chat-box__header d-flex align-items-center border-bottom p-3"
                >
                  <img
                    :src="
                ...
                <div
                  class="chat-box__body p-3 d-flex flex-column flex-grow-1"
                  v-chat-scroll
                >
                  <Message
                    ...
                    :key="message.id"
                    :message="message"
                    :self="message.messagableId == $auth.user.id"
                  ></Message>
                </div>
