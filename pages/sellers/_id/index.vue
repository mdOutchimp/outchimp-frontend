      ...
      <PageHeader>
        <div class="col-md-8">
          <div class="d-flex flex-column flex-sm-row align-items-center">
            ...
            <div
              class="ms-sm-2 mt-3 mt-sm-0 d-flex flex-column align-items-center align-items-sm-start"
            >
              <div class="d-flex">
        ...
        <div
          class="col-md-4 text-center text-sm-start text-md-end mt-2 mt-md-0"
        >
          <nuxt-link
            :to="`/buyers/chat?sellerId=${seller.id}`"
            class="btn btn-outline-primary px-4 rounded-pill mt-1 mt-md-0 text-decoration-none"
          >
                ...
                <div class="card-body">
                  ...
                  <div class="mb-4">
                    ...
                    <div class="" v-if="seller.experiences.length">
                      <div
                        v-for="experience in seller.experiences"
                        :key="experience.id"
                      >
                        <small>
                          {{ experience.joinedAt }} -
                  ...
                  <div class="mb-4">
                    ...
                    <div v-if="seller.educations.length">
                      <div
                        v-for="education in seller.educations"
                        :key="education.id"
                      >
                        <p class="fs-7">
                  ...
                  <div class="mb-4">
                    ...
                    <div class="mt-2" v-if="seller.devices.length">
                      <span
                        ...
                        v-for="(device, index) in seller.devices"
                        :key="index"
                        >{{ device }}</span
                      >
                    </div>
                  ...
                  <div class="mb-4">
                    ...
                    <div class="mt-2" v-if="seller.skills.length">
                      <span
                        href="javascript:void(0)"
                        class="badge border border-primary text-primary rounded-pill me-2"
                        v-for="skill in seller.skills"
                        :key="skill.id"
                        >{{ skill.name }}</span
                      >
                    </div>
      ...
      <section class="section-padding bg-white">
        <div class="container">
          ...
          <div v-else class="text-center">
            <span class="border border-primary rounded px-4 py-2"
...
export default {
  ...
  async fetch() {
    const resOne = await this.$axios.$get("sellers/" + this.$route.params.id);
